...
export class Body extends Component {
  ...
  handleLoadChange() {
    ...
    count++;
    this.setState({
      imagesLoading: !this.imagesLoaded(
  ...
  render() {
    let allImages = this.state.diceOne.concat(
      this.state.diceTwo,
      this.state.diceThree,
      this.state.diceFour,
      this.state.diceFive,
      this.state.diceSix,
      this.state.diceSeven,
      this.state.diceEight,
      this.state.diceNine,
      this.state.diceTen,
      this.state.diceEleven,
      this.state.diceTwelve,
      this.state.diceThirteen,
      this.state.diceFourteen,
      this.state.diceFifteen,
      this.state.diceSixteen,
      this.state.diceSeventeen,
      this.state.diceEighteen
    );
